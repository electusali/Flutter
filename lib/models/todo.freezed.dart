...
// ignore: unused_element
  _Todo call({int id, @required String title, int complete = 0}) {
    return _Todo(
      id: id,
      title: title,
      complete: complete,
...
abstract class $TodoCopyWith<$Res> {
  ...
  $Res call({int id, String title, int complete});
}
...
class _$_Todo extends _Todo {
  _$_Todo({this.id, @required this.title, this.complete = 0})
      : assert(title != null),
...
abstract class _Todo extends Todo {
  _Todo._() : super._();
  factory _Todo({int id, @required String title, int complete}) = _$_Todo;
